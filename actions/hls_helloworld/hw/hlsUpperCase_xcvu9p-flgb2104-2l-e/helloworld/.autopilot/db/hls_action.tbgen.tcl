...
"1": [ "action_reg", {"typedef": [[[],"3"],""]}], 
"3": [ "", {"struct": [[],[],[{ "Control": [[128], "4"]},{ "Data": [[256], "5"]},{ "padding": [[],  {"array": ["6", [76]]}]}],""]}], 
"4": [ "CONTROL", {"typedef": [[[],"7"],""]}], 
"0": [ "snap_membus_t", {"typedef": [[[],"8"],""]}], 
"8": [ "ap_uint<512>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 512}}]],""]}}], 
"2": [ "action_RO_config_reg", {"typedef": [[[],"9"],""]}], 
"7": [ "", {"struct": [[],[],[{ "sat": [[8], "10"]},{ "flags": [[8], "10"]},{ "seq": [[16], "11"]},{ "Retc": [[32], "12"]},{ "Reserved": [[64], "13"]}],""]}], 
"12": [ "snapu32_t", {"typedef": [[[],"14"],""]}], 
"10": [ "snapu8_t", {"typedef": [[[],"15"],""]}], 
"15": [ "ap_uint<8>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 8}}]],""]}}], 
"11": [ "snapu16_t", {"typedef": [[[],"16"],""]}], 
"6": [ "uint8_t", {"typedef": [[[], {"scalar": "unsigned char"}],""]}], 
"9": [ "", {"struct": [[],[],[{ "action_type": [[32], "12"]},{ "release_level": [[32], "12"]}],""]}], 
"16": [ "ap_uint<16>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 16}}]],""]}}], 
"14": [ "ap_uint<32>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 32}}]],""]}}], 
"13": [ "snapu64_t", {"typedef": [[[],"17"],""]}], 
"17": [ "ap_uint<64>", {"hls_type": {"ap_uint": [[[[], {"scalar": { "int": 64}}]],""]}}], 
"5": [ "helloworld_job_t", {"typedef": [[[],"18"],""]}], 
"18": [ "helloworld_job", {"struct": [[],[],[{ "in": [[], "19"]},{ "out": [[], "19"]}],""]}], 
"19": [ "snap_addr", {"struct": [[],[],[{ "addr": [[64], "20"]},{ "size": [[32], "21"]},{ "type": [[16], "22"]},{ "flags": [[16], "23"]}],""]}], 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"VariableLatency" : "1",
		"WaitState" : [
			{"State" : "ap_ST_fsm_state2", "FSM" : "ap_CS_fsm", "SubInstance" : "grp_process_action_fu_141"}],
		"Port" : [
			{"Name" : "host_mem", "Type" : "MAXI", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "grp_process_action_fu_141", "Port" : "din_gmem_V"}]},
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_process_action_fu_141", "Parent" : "0", "Child" : ["4"],
		"CDFG" : "process_action",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"FunctionPipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"Combinational" : "0",
		...
		"Port" : [
			...
			{"Name" : "din_gmem_V_offset", "Type" : "None", "Direction" : "I"},
			{"Name" : "dout_gmem_V_offset", "Type" : "None", "Direction" : "I"},
	...
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_process_action_fu_141.text_U", "Parent" : "3"}]}


set ArgLastReadFirstWriteLatency {
	hls_action {
		host_mem {Type IO LastRead 76 FirstWrite 75}
		din_gmem_V {Type I LastRead 0 FirstWrite -1}
		dout_gmem_V {Type I LastRead 0 FirstWrite -1}
		act_reg {Type IO LastRead 1 FirstWrite 1}
		Action_Config {Type O LastRead -1 FirstWrite 0}}
	process_action {
		din_gmem_V {Type IO LastRead 76 FirstWrite 75}
		din_gmem_V_offset {Type I LastRead 0 FirstWrite -1}
		dout_gmem_V_offset {Type I LastRead 0 FirstWrite -1}
		act_reg_Data_in_addr {Type I LastRead 0 FirstWrite -1}
		act_reg_Data_in_size {Type I LastRead 0 FirstWrite -1}
		act_reg_Data_out_add {Type I LastRead 0 FirstWrite -1}}}
