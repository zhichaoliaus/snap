...
set C_modelArgList {
	...
	{ din_gmem_V_offset int 58 regular  }
	{ dout_gmem_V_offset int 58 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "din_gmem_V", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READWRITE"} , 
 	{ "Name" : "din_gmem_V_offset", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
 	{ "Name" : "dout_gmem_V_offset", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ din_gmem_V_offset sc_in sc_lv 58 signal 1 } 
	{ dout_gmem_V_offset sc_in sc_lv 58 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "din_gmem_V_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "din_gmem_V_offset", "role": "default" }} , 
 	{ "name": "dout_gmem_V_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "dout_gmem_V_offset", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.text_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	din_gmem_V_offset { ap_none {  { din_gmem_V_offset in_data 0 58 } } }
	dout_gmem_V_offset { ap_none {  { dout_gmem_V_offset in_data 0 58 } } }
